...
public class CarController5 : MonoBehaviour
{
    ...
    public SpringJoint2D frontSuspension2;
    //public SpringJoint2D backSuspension;
    //public SpringJoint2D backSuspension2;

    public WheelJoint2D frontwheel;
    public WheelJoint2D frontwheel2;
    public WheelJoint2D backwheel;
    public WheelJoint2D backwheel2;
    ...
    void Update()
    {
        ...
        {
            gasLeak = 0.017f * (8 + TankLevel);
            backwheel.useMotor = false;
            backwheel2.useMotor = false;
            frontwheel.useMotor = false;
            frontwheel2.useMotor = false;

        }
        torqueF = (130f * EngineLevel + 4400) * 0.125f;
        torqueB = (130f * EngineLevel + 4400) * 0.125f;
        speedF = (130f * EngineLevel + 4400) * 0.125f;
        ...
        frontSuspension2.frequency = (SuspensionLevel + 1) * 0.25f;
