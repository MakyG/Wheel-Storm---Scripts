...
public class CarController2 : MonoBehaviour
{
    ...
    public static float torqueF = 340f;
    public static float torqueB = 340f;
    ...
    private float carRotationSpeed = 14;
    ...
    void Update()
    {
        ...
        speedF = (140f * EngineLevel + 4400) * 0.25f;
        torqueF = (140f * EngineLevel + 4400) * 0.25f;
        torqueB = (140f * EngineLevel + 4400) * 0.25f;
        UpgradeCost = 400 * (EngineLevel) + 400;

        carRotationSpeed = RotationLevel + 8;
        UpgradeCostRotation = 400 * (RotationLevel) + 400;

        frontSuspension.frequency = (SuspensionLevel + 1) * 0.22f;
        backSuspension.frequency = (SuspensionLevel + 1) * 0.22f;
        UpgradeCostSuspension = 400 * (SuspensionLevel) + 400;

        UpgradeCostTank = 400 * (TankLevel) + 400;

        WheelMaterial.wheelFriction = 0.1f + (0.1f * (TiresLevel + 1));
