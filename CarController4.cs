...
public class CarController4 : MonoBehaviour
{
    ...
    public AudioSource ThrottleSound2;
    ...
    public static float speedF = 1100f;
    public static float speedB = -1100f;
    public float dirX;
    public float speedReal;
    public float speedRealFloored;
    public float arrowAngle;

    public static float torqueF = 320f;
    public static float torqueB = 320f;
    ...
    public static float carRotationSpeed = 12;
    ...
    void Update()
    {
        ...
        ThrottleSound.pitch = (speedReal / 100);
        ThrottleSound.volume = 0.5f;
        ThrottleSound2.pitch = (speedReal / 100);
        ThrottleSound2.volume = 0.2f;
        ...
        if (CrossPlatformInputManager.GetAxis("Horizontal") > 0 && gas > 0)
        {
            ...
            ThrottleSound2.volume = 0.5f;
            ThrottleSound2.pitch = (speedReal / 80) + 0.1f;
        ...
        torqueF = (140f * EngineLevel + 4200) * 0.25f;
        torqueB = (140f * EngineLevel + 4200) * 0.25f;
        speedF = (140f * EngineLevel + 4200) * 0.25f;
