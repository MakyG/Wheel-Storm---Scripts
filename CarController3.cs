...
public class CarController3 : MonoBehaviour
{
    ...
    public static float speedF = 1050f;
    public static float speedB = -1050f;
    public float dirX;
    public float speedReal;
    public float speedRealFloored;
    public float arrowAngle;

    public static float torqueF = 330f;
    public static float torqueB = 330f;
    ...
    void Update()
    {
        ...
        torqueF = (130f * EngineLevel + 4300) * 0.25f;
        torqueB = (130f * EngineLevel + 4300) * 0.25f;
        speedF = (130f * EngineLevel + 4300) * 0.25f;
        UpgradeCost = 400 * (EngineLevel) + 400;

        carRotationSpeed = RotationLevel + 8;
        UpgradeCostRotation = 400 * (RotationLevel) + 400;

        frontSuspension.frequency = (SuspensionLevel + 1) * 0.08f;
        backSuspension.frequency = (SuspensionLevel + 1) * 0.08f;
